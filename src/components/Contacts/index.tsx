          ...
          <ContactsCards>
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Caso queira entrar em contato o meu Whatsapp e um otimo meio para isso
                </Text>
                <Text
                  as="a"
                  color="grey2"
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Caso queria mandar feedback ou apenas entrar em contato, tambem pode me enviar um email! 
                </Text>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Aqui voce pode ir diretamente para o meu linkedin para ver um pouco mais das coisas que estou fazendo atualmente
                </Text>
                <Text
                  as="a"
                  color="grey2"
